...
public class IR {
	...
	public void simples() 
	{
		...
		System.out.println("Insira o valor da renda mensal: ");
	...
	public void detalhada()
	{
		...
		while (impfonte<0)
			{
			System.out.println("Qual o valor das deduções durante o ano? (Para informações detalhadas insira um número negativo)");
	...
	{	
		...
		System.out.println("Bem vindo ao simulador de Imposto de renda, selecione a opção desejada: ");
	...
	public void total()
	{
		...
		System.out.printf("\nO Valor do Imposto de Renda será de: R$ %.2f", ir);
